...
# import cv2
# NOTE (mask_postprocessing): utm / fiona / osmnx / osgeo are imported upstream at
# module level but are only used by the geo-referencing half (wkt_to_G, main),
# which we never call -- only the pixel-space functions are reused.
from . import rdp
